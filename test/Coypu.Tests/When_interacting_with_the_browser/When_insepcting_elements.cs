...
package Coypu.Tests.When_interacting_with_the_browser
{
    ...
    public class When_insepcting_elements : BrowserInteractionTests
    {
        ...
        public void It_finds_element_robustly_and_returns_id()
        {
            ...
            assertThat(browserSession.FindId("some-element").Id, Is.EqualTo("actual-id"));

            RunQueryAndCheckTiming<ElementFound>();

            assertThat(queryResult, Is.SameAs(stubElement));
        }
        ...
        public void It_finds_element_robustly_and_returns_text()
        {
            ...
            assertThat(browserSession.FindId("some-element").Text, Is.EqualTo("actual-text"));
        ...
        public void It_finds_element_robustly_and_returns_value()
        {
            ...
            assertThat(browserSession.FindId("some-element").Value, Is.EqualTo("actual-value"));
        ...
        public void It_finds_element_robustly_and_returns_attributes()
        {
            ...
            assertThat(browserSession.FindId("some-element")["href"], Is.EqualTo("http://some.href"));
        ...
        public void It_finds_element_robustly_and_returns_name()
        {
            ...
            assertThat(browserSession.FindId("some-element").Name, Is.EqualTo("actual-name"));
        ...
        public void It_finds_element_robustly_and_returns_selected_option()
        {
            ...
            assertThat(browserSession.FindId("some-element").SelectedOption, Is.EqualTo("actual-selected-option"));
        ...
        public void It_finds_element_robustly_and_returns_selected_positive()
        {
            ...
            assertThat(browserSession.FindId("some-element").Selected, Is.EqualTo(true));
        ...
        public void It_finds_element_robustly_and_returns_selected_negative()
        {
            ...
            assertThat(browserSession.FindId("some-element").Selected, Is.EqualTo(false));
        ...
        public void It_finds_element_robustly_and_returns_native()
        {
            ...
            assertThat(browserSession.FindId("some-element").Native, Is.SameAs(native));
