...
package Coypu.Drivers.Tests
{
    public class When_finding_links extends DriverSpecs
    {
        ...
        {
            Driver().FindLink("first link", Root()).Id(), is(equalTo("firstLinkId");
            Driver().FindLink("second link", Root()).Id(), is(equalTo("secondLinkId");
        }
        ...
        {
            Element link = Driver().FindLink("I'm a link with \"both\" types of quote in my text", Root());
