...
namespace Coypu.Tests.TestDoubles
{
    ...
    {
        public final IList<Element> ClickedElements = new List<Element>();
        public final IList<Element> HoveredElements = new List<Element>();
        public final IList<Element> CheckedElements = new List<Element>();
        public final IList<Element> UncheckedElements = new List<Element>();
        public final IList<Element> ChosenElements = new List<Element>();
        public final IList<string> HasContentQueries = new List<string>();
        public final IList<Regex> HasContentMatchQueries = new List<Regex>();
        public final IList<string> HasCssQueries = new List<string>();
        public final IList<string> HasXPathQueries = new List<string>();
        public final IList<string> Visits = new List<string>();
        public final IDictionary<Element, string> SetFields = new Dictionary<Element, string>();
        public final IDictionary<Element, string> SelectedOptions = new Dictionary<Element, string>();
        private final IList<ScopedStubResult> stubbedButtons = new List<ScopedStubResult>();
        private final IList<ScopedStubResult> stubbedLinks = new List<ScopedStubResult>();
        private final IList<ScopedStubResult> stubbedTextFields = new List<ScopedStubResult>();
        private final IList<ScopedStubResult> stubbedCssResults = new List<ScopedStubResult>();
        private final IList<ScopedStubResult> stubbedXPathResults = new List<ScopedStubResult>();
        private final IList<ScopedStubResult> stubbedAllCssResults = new List<ScopedStubResult>();
        private final IList<ScopedStubResult> stubbedAllXPathResults = new List<ScopedStubResult>();
        private final IList<ScopedStubResult> stubbedExecuteScriptResults = new List<ScopedStubResult>();
        private final IList<ScopedStubResult> stubbedFieldsets = new List<ScopedStubResult>();
        private final IList<ScopedStubResult> stubbedSections = new List<ScopedStubResult>();
        private final IList<ScopedStubResult> stubbedIFrames = new List<ScopedStubResult>();
        private final IList<ScopedStubResult> stubbedIDs = new List<ScopedStubResult>();
        private final IList<ScopedStubResult> stubbedHasContentResults = new List<ScopedStubResult>();
        private final IList<ScopedStubResult> stubbedHasContentMatchResults = new List<ScopedStubResult>();
        private final IList<ScopedStubResult> stubbedHasCssResults = new List<ScopedStubResult>();
        private final IList<ScopedStubResult> stubbedHasXPathResults = new List<ScopedStubResult>();
        private final IList<ScopedStubResult> stubbedHasDialogResults = new List<ScopedStubResult>();
        private final List<ScopedStubResult> stubbedWindows = new List<ScopedStubResult>();
        public final IList<string> FindButtonRequests = new List<string>();
        public final IList<string> FindLinkRequests = new List<string>();
        public final IList<string> FindCssRequests = new List<string>();
