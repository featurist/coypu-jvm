...
package coypu.unitTests.When_making_direct_web_requests
{
    [TestFixture]
    public class When_saving_a_resource_from_the_web
    {
        ...
        public void It_downloads_the_resource_from_the_given_url_and_saves_to_the_given_location()
        {
            ...
            assertThat(downloadedFile.Resource, Is.EqualTo("http://built.by/url_builder"));
            assertThat(downloadedFile.SaveAs, Is.EqualTo(@"T:\saveme\here.please"));
        }
        ...
        public void It_passes_the_current_driver_cookies_to_the_resource_downloader()
        {
            ...
            assertThat(downloadedFile.Cookies, Is.EqualTo(cookies));
        }
