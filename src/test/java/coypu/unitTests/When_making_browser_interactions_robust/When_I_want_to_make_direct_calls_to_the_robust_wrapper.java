...
import coypu.unitTests.When_interacting_with_the_browser.BrowserInteractionTests;
...
public class When_I_want_to_make_direct_calls_to_the_robust_wrapper extends BrowserInteractionTests
{
    ...
    public void retryUntilTimeout_is_exposed_on_the_session()
    {
        ...
        browserSession.retryUntilTimeout(new BrowserAction(sessionConfiguration) {
            public void act() {
