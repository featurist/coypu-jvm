...
public class When_inspecting_the_page extends When_inspecting
{
    ...
    public void hasNoContent_queries_robustly_Positive_example()
    {
        ...
        boolean actualImmediateResult = (boolean) browserSession.hasNoContent(locator, sessionConfiguration);
    ...
    public void hasNoContentMatch_queries_robustly_Positive_example()
    {
        ...
        boolean actualImmediateResult = browserSession.hasNoContentMatch(pattern, sessionConfiguration);
    ...
    public void hasNoCss_queries_robustly_Positive_example()
    {
        ...
        boolean actualImmediateResult = browserSession.hasNoCss(locator, sessionConfiguration);
    ...
    public void hasNoXPath_queries_robustly_Positive_example()
    {
        ...
        boolean actualImmediateResult = browserSession.hasNoXPath(locator, sessionConfiguration);
