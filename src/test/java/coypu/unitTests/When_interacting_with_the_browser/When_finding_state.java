...
import coypu.unitTests.TestDoubles.FakeWaiter;
...
import coypu.unitTests.When_making_browser_interactions_robust.AlwaysSucceedsPredicateQuery;
...
public class When_finding_state
{
    ...
    public void it_returns_the_state_that_was_found_first_Example_1()
    {
        ...
        State state1 = new AlwaysSucceedsPredicateQuery(true, TimeSpan.zero(), sessionConfiguration.RetryInterval);
        State state2 = new AlwaysSucceedsPredicateQuery(false, TimeSpan.zero(), sessionConfiguration.RetryInterval);
        State state3 = new AlwaysSucceedsPredicateQuery(false, TimeSpan.zero(), sessionConfiguration.RetryInterval);
    ...
    public void it_returns_the_state_that_was_found_first_Example_2()
    {
        ...
        State state1 = new AlwaysSucceedsPredicateQuery(false, TimeSpan.zero(), sessionConfiguration.RetryInterval);
        State state2 = new AlwaysSucceedsPredicateQuery(true, TimeSpan.zero(), sessionConfiguration.RetryInterval);
        State state3 = new AlwaysSucceedsPredicateQuery(false, TimeSpan.zero(), sessionConfiguration.RetryInterval);
    ...
    public void it_returns_the_state_that_was_found_first_Example_3()
    {
        ...
        State state1 = new AlwaysSucceedsPredicateQuery(false, TimeSpan.zero(), sessionConfiguration.RetryInterval);
        State state2 = new AlwaysSucceedsPredicateQuery(false, TimeSpan.zero(), sessionConfiguration.RetryInterval);
        State state3 = new AlwaysSucceedsPredicateQuery(true, TimeSpan.zero(), sessionConfiguration.RetryInterval);
