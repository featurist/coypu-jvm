...
public class SectionFinder  extends XPathQueryFinder 
{
    public SectionFinder(Driver driver, String locator, DriverScope scope, Options options) throws Exception {
