...
public class FieldsetFinder  extends XPathQueryFinder 
{
    public FieldsetFinder(Driver driver, String locator, DriverScope scope, Options options) throws Exception {
