...
public class FindAllCssWithPredicateQuery  extends DriverScopeQuery<IEnumerable<SnapshotElementScope>> 
{
    ...
    public FindAllCssWithPredicateQuery(String locator, Func<IEnumerable<SnapshotElementScope>, Boolean> predicate, DriverScope driverScope, Options options) throws Exception {
    ...
    public IEnumerable<SnapshotElementScope> run() throws Exception {
        /* [UNSUPPORTED] 'var' as type is unsupported "var" */ allElements = getDriverScope().FindAllCssNoPredicate(locator, getOptions()).ToArray();
