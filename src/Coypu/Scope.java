...
public interface Scope
{
    ...
    void ClickButton(String locator, Options options) throws MissingHtmlException;
    ...
    /// <code>new Options{Timeout = TimeSpan .FromSeconds(60)}</code></param>
    /// <exception cref="T:Coypu.MissingHtmlException">Thrown if the element cannot be found</exception>
    void ClickLink(String locator, Options options) throws MissingHtmlException;
    ...
    boolean HasContent(String text, Options options) throws MissingHtmlException;
    ...
    boolean HasContentMatch(Pattern pattern, Options options) throws MissingHtmlException;
    ...
    boolean HasNoContent(String text, Options options) throws MissingHtmlException;
    ...
    /// <code>new Options{Timeout = TimeSpan .FromSeconds(60)}</code></param>
    /// <returns>Whether the text does not appear</returns>
    boolean HasNoContentMatch(Pattern pattern, Options options) throws MissingHtmlException;
    ...
    boolean HasCss(String cssSelector, Options options) throws MissingHtmlException;
    ...
    boolean HasNoCss(String cssSelector, Options options) throws MissingHtmlException;
    ...
    /// <code>new Options{Timeout = TimeSpan .FromSeconds(60)}</code></param>
    /// <returns>Whether an element appears</returns>
    boolean HasXPath(String xpath, Options options) throws MissingHtmlException;
    ...
    /// <code>new Options{Timeout = TimeSpan .FromSeconds(60)}</code></param>
    /// <returns>Whether an element appears</returns>
    boolean HasNoXPath(String xpath, Options options) throws MissingHtmlException;
    ...
    Iterable<ElementFound> FindAllCss(String cssSelector, Options options) throws MissingHtmlException;
    ...
    /// <code>new Options{Timeout = TimeSpan .FromSeconds(60)}</code></param>
    /// <returns>All matching elements</returns>
    Iterable<ElementFound> FindAllXPath(String xpath, Options options) throws MissingHtmlException;
    ...
    /// <code>new Options{Timeout = TimeSpan .FromSeconds(60)}</code></param>
    /// <exception cref="T:Coypu.MissingHtmlException">Thrown if the element cannot be found</exception>
    void Check(String locator, Options options) throws MissingHtmlException;
    ...
    /// <code>new Options{Timeout = TimeSpan .FromSeconds(60)}</code></param>
    /// <exception cref="T:Coypu.MissingHtmlException">Thrown if the element cannot be found</exception>
    void Uncheck(String locator, Options options) throws MissingHtmlException;
    ...
    /// <code>new Options{Timeout = TimeSpan .FromSeconds(60)}</code></param>
    /// <exception cref="T:Coypu.MissingHtmlException">Thrown if the element cannot be found</exception>
    void Choose(String locator, Options options) throws MissingHtmlException;
    ...
    String ExecuteScript(String javascript) throws MissingHtmlException;

    /// <summary>
    /// Query whether an element appears within the configured timeout
    /// </summary>
    /// <param name="findElement">A function to find an element</param>
    boolean Has(ElementScope findElement, Options options) throws MissingHtmlException;
    ...
    /// </summary>
    /// <param name="findElement">A function to find an element</param>
    boolean HasNo(ElementScope findElement, Options options) throws MissingHtmlException;
    ...
    ///
    /// <code>new Options{Timeout = TimeSpan .FromSeconds(60)}</code></param>
    void RetryUntilTimeout(BrowserAction action) throws MissingHtmlException;
    ...
    <T> T Query(Query<T> query) throws MissingHtmlException;
    ...
    void TryUntil(BrowserAction tryThis, PredicateQuery until,  TimeSpan waitBeforeRetry, Options options) throws MissingHtmlException, TimeoutException;
    ...
    /// <exception cref="T:Coypu.MissingHtmlException">Thrown if the element cannot be found</exception>
    DriverScope ClickButton(String locator, PredicateQuery until,  TimeSpan waitBeforeRetry, Options options) throws TimeoutException, MissingHtmlException;
    ...
    /// <returns>The first matching button</returns>
    /// <exception cref="T:Coypu.MissingHtmlException">Thrown if the element cannot be found</exception>
    DriverScope ClickLink(String locator, PredicateQuery until,  TimeSpan waitBeforeRetry, Options options) throws TimeoutException, MissingHtmlException;
