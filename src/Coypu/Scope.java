...
public interface Scope
{
    ...
    void ClickButton(String locator, Options options) throws TimeoutException;
    ...
    /// <code>new Options{Timeout = TimeSpan .FromSeconds(60)}</code></param>
    /// <exception cref="T:Coypu.MissingHtmlException">Thrown if the element cannot be found</exception>
    void ClickLink(String locator, Options options) throws TimeoutException;
    ...
    boolean HasContent(String text, Options options) throws TimeoutException;
    ...
    boolean HasContentMatch(Pattern pattern, Options options) throws TimeoutException;
    ...
    boolean HasNoContent(String text, Options options) throws TimeoutException;
    ...
    /// <code>new Options{Timeout = TimeSpan .FromSeconds(60)}</code></param>
    /// <returns>Whether the text does not appear</returns>
    boolean HasNoContentMatch(Pattern pattern, Options options) throws TimeoutException;
    ...
    boolean HasCss(String cssSelector, Options options) throws TimeoutException;
    ...
    boolean HasNoCss(String cssSelector, Options options) throws TimeoutException;
    ...
    /// <code>new Options{Timeout = TimeSpan .FromSeconds(60)}</code></param>
    /// <returns>Whether an element appears</returns>
    boolean HasXPath(String xpath, Options options) throws TimeoutException;
    ...
    /// <code>new Options{Timeout = TimeSpan .FromSeconds(60)}</code></param>
    /// <returns>Whether an element appears</returns>
    boolean HasNoXPath(String xpath, Options options) throws TimeoutException;
    ...
    Iterable<ElementFound> FindAllCss(String cssSelector, Options options) throws MissingHtmlException, TimeoutException;
    ...
    /// <code>new Options{Timeout = TimeSpan .FromSeconds(60)}</code></param>
    /// <returns>All matching elements</returns>
    Iterable<ElementFound> FindAllXPath(String xpath, Options options) throws MissingHtmlException, TimeoutException;
    ...
    /// <code>new Options{Timeout = TimeSpan .FromSeconds(60)}</code></param>
    /// <exception cref="T:Coypu.MissingHtmlException">Thrown if the element cannot be found</exception>
    void Check(String locator, Options options) throws TimeoutException;
    ...
    /// <code>new Options{Timeout = TimeSpan .FromSeconds(60)}</code></param>
    /// <exception cref="T:Coypu.MissingHtmlException">Thrown if the element cannot be found</exception>
    void Uncheck(String locator, Options options) throws TimeoutException;
    ...
    /// <code>new Options{Timeout = TimeSpan .FromSeconds(60)}</code></param>
    /// <exception cref="T:Coypu.MissingHtmlException">Thrown if the element cannot be found</exception>
    void Choose(String locator, Options options) throws TimeoutException;
    ...
    String ExecuteScript(String javascript) throws MissingHtmlException, TimeoutException;

    /// <summary>
    /// Query whether an element appears within the configured timeout
    /// </summary>
    /// <param name="findElement">A function to find an element</param>
    boolean Has(ElementScope findElement, Options options) throws TimeoutException;
    ...
    /// </summary>
    /// <param name="findElement">A function to find an element</param>
    boolean HasNo(ElementScope findElement, Options options) throws TimeoutException;
    ...
    ///
    /// <code>new Options{Timeout = TimeSpan .FromSeconds(60)}</code></param>
    void RetryUntilTimeout(BrowserAction action) throws TimeoutException;
    ...
    <T> T Query(Query<T> query) throws TimeoutException;
    ...
    void TryUntil(BrowserAction tryThis, PredicateQuery until,  TimeSpan waitBeforeRetry, Options options) throws MissingHtmlException, java.util.concurrent.TimeoutException, TimeoutException;
    ...
    State FindState(State[] states, Options options) throws MissingHtmlException, TimeoutException;
    ...
    /// <exception cref="T:Coypu.MissingHtmlException">Thrown if the element cannot be found</exception>
    DriverScope ClickButton(String locator, PredicateQuery until,  TimeSpan waitBeforeRetry, Options options) throws MissingHtmlException, java.util.concurrent.TimeoutException, TimeoutException;
    ...
    /// <returns>The first matching button</returns>
    /// <exception cref="T:Coypu.MissingHtmlException">Thrown if the element cannot be found</exception>
    DriverScope ClickLink(String locator, PredicateQuery until,  TimeSpan waitBeforeRetry, Options options) throws MissingHtmlException, java.util.concurrent.TimeoutException, TimeoutException;
